 ...
 * Challenge:
 * [ENGLISH]:
 * Integrating Exercise: Dog Grooming Salon. A dog grooming salon needs <b>a form</b>
 * to <b>store the data of each of its client pets.</b> For this, it requests the
 * development of an application that is able to register the following data for
 * each of them and their owners:
 * 1) Pets: num_clientes, numbre_perro, raza, color, alergico, atencion_especial,
 * observaciones.
 * 2) Owner: id_dueño, nombre, celular, direccion.
