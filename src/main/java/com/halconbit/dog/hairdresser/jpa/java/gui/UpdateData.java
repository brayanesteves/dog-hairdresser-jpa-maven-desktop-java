...
public class UpdateData extends javax.swing.JFrame {
     ...
     */
    public UpdateData(int customer_number) {
        this.customer_number = customer_number;
        initComponents();
        loadItemComboBox();
        loadDatas(customer_number);
    }
    ...
    private void initComponents() {
        ...
        labelTitle.setText("Update Data");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(buttonUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void loadDatas(int customer_number) {
        ...
        this.textfieldBreed.setText(pet.getBreed());
        this.textfieldColor.setText(pet.getColor());
        this.textareaObservatios.setText(pet.getObservations());        
        this.textfieldOwnersName.setText(pet.getOwner().getName());
        this.textfieldOwnersPhone.setText(pet.getOwner().getCellphone_number());
        
        if(pet.getAllergic().equals("Yes")) {
            this.comboboxAllergic.setSelectedIndex(1);
        } else if(pet.getAllergic().equals("No")) {
            this.comboboxAllergic.setSelectedIndex(2);
        } else {
            this.comboboxAllergic.setSelectedIndex(0);
        }
        
        if(pet.getSpecial_care().equals("Yes")) {
            this.comboboxSpecialAttention.setSelectedIndex(1);
        } else if(pet.getSpecial_care().equals("No")) {
            this.comboboxSpecialAttention.setSelectedIndex(2);
        } else {
            this.comboboxSpecialAttention.setSelectedIndex(0);
        }
