package com.halconbit.dog.hairdresser.jpa.java.persistence;
...
public class PetJpaController implements Serializable {
    ...
    public PetJpaController() {
        this.emf = Persistence.createEntityManagerFactory("DogHairdresserPersistenceUnit");
    }
